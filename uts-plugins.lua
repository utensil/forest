...
local lang_plugins = {
    {
        ...
        -- The following is based on https://github.com/stevearc/conform.nvim/issues/192#issuecomment-2573170631
        -- To be able to disable autoformat
        lazy = false,
        keys = {
            {
                "<leader>tf",
...
local llm_plugins_ws = {
    {
        "Exafunction/windsurf.vim",
        event = "BufEnter",
        keys = {
            { "<leader>aa", "<cmd>:Codeium Chat<cr>", desc = "Codeium - Chat" },
        },
    },
}
...
local llm_plugins = llm_plugins_ws
