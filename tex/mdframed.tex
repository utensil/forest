...
% AGENT-NOTE: Unnumbered cards must not retain a preceding card's displayed number.
\newcommand{\forestunnumberedcard}{%
	\let\forestcurrentnumber\@empty
}
...
\declaretheorem[style=def,name=Proposition,numbered=no]{proposition}
\declaretheorem[style=def,name=Conjecture,numbered=no]{conjecture}
